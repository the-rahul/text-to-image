...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-to-image
```

A live public deployment of this template is available at [https://text-to-image.templates.workers.dev](https://text-to-image.templates.workers.dev)
